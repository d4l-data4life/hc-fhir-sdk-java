...
tpl_resource_source = 'template-resource.adoc'  # the template to use as source when writing resource implementations for profiles
tpl_resource_target = 'models'  # target directory to write the generated class files to
tpl_resource_target_ptrn = '{}.adoc'  # where to write the generated class files to, with one "{}" placeholder for the class name
tpl_codesystems_source = 'template-codesystems.adoc'  # the template to use as source when writing enums for CodeSystems; can be `None`
tpl_codesystems_target_name = 'CodeSystems.adoc'  # the filename to use for the generated code systems and value sets (in `tpl_resource_target`)

# Whether and where to put the factory methods
write_factory = True
tpl_factory_source = 'template-elementfactory.adoc'          # the template to use for factory generation
tpl_factory_target = 'models/index.adoc'                               # where to write the generated factory to
write_dependencies = False
# tpl_dependencies_source = 'template-dependencies.adoc'     # template used to render the JSON dependency graph
...
#tpl_unittest_source = 'template-unittest.adoc'  # the template to use for unit test generation
#tpl_unittest_target = 'tests'  # target directory to write the generated unit test files to
#tpl_unittest_target_ptrn = '{}Test.adoc'  # a pattern to determine the output files for unit tests; the one placeholder will be the class name
