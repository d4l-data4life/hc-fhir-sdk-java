...
public class FhirStu3MoshiJsonParserTest {
    ...
    // SUT
    private FhirStu3MoshiJsonParser parser;


    @Before
    public void setup() {
        parser = new FhirStu3MoshiJsonParser(mockMoshi);
    ...
    public void fromJson() throws Exception {
        ...
        when(mockMoshi.adapter(FhirStu3Base.class)).thenReturn(mockAdapter);
        ...
        inOrder.verify(mockMoshi).adapter(FhirStu3Base.class);
