...
public class QuestionnaireResponseTest {
    ...
    @Test
    public void testQuestionnaireResponse1() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaireresponse-example.json");
        QuestionnaireResponse data = parser.toFhir(QuestionnaireResponse.class, sourceJson);

        assertEquals(data.author.reference, "#questauth");
        assertEquals(data.authored.toString(), "2013-02-19T14:15:00-05:00");
        ...
        assertEquals(data.identifier.system, "http://example.org/fhir/NamingSystem/questionnaire-ids");
        assertEquals(data.identifier.value, "Q12349876");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(0).answer.get(
                0).valueCoding.code, "1");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(0).answer.get(
                0).valueCoding.system, "http://cancer.questionnaire.org/system/code/yesno");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(0).linkId,
                "1.1.1.1");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(1).answer.get(
                0).valueCoding.code, "1");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(1).answer.get(
                0).valueCoding.system, "http://cancer.questionnaire.org/system/code/yesno");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(1).linkId,
                "1.1.1.2");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(2).answer.get(
                0).valueCoding.code, "0");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(2).answer.get(
                0).valueCoding.system, "http://cancer.questionnaire.org/system/code/yesno");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).item.get(0).item.get(2).linkId,
                "1.1.1.3");
        ...
        assertEquals(data.item.get(0).item.get(0).answer.get(0).valueCoding.system,
        ...
        assertEquals(data.status, CodeSystems.QuestionnaireResponseStatus.COMPLETED);
    ...
    @Test
    public void testQuestionnaireResponse2() throws Exception {
        String sourceJson =
                FileHelper.loadString("questionnaireresponse-example-ussg-fht-answers.json");
        QuestionnaireResponse data = parser.toFhir(QuestionnaireResponse.class, sourceJson);

        assertEquals(data.authored.toString(), "2008-01-17");
        assertEquals(data.id, "ussg-fht-answers");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).valueDate.toString(), "2008-01-17");
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(0).answer.get(0).valueString,
                "Annie Proband");
        assertEquals(data.item.get(1).item.get(0).item.get(0).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(1).answer.get(0).valueCoding.code, "LA3-6");
        assertEquals(data.item.get(1).item.get(0).item.get(1).answer.get(0).valueCoding.display,
                "Female");
        assertEquals(data.item.get(1).item.get(0).item.get(1).answer.get(0).valueCoding.system,
                "http://loinc.org");
        assertEquals(data.item.get(1).item.get(0).item.get(1).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(2).answer.get(0).valueDate.toString(),
                "1966-04-04");
        assertEquals(data.item.get(1).item.get(0).item.get(2).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(3).answer.get(0).valueCoding.code, "LA32-8");
        assertEquals(data.item.get(1).item.get(0).item.get(3).answer.get(0).valueCoding.display, "No");
        assertEquals(data.item.get(1).item.get(0).item.get(3).answer.get(0).valueCoding.system,
                "http://loinc.org");
        assertEquals(data.item.get(1).item.get(0).item.get(3).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(4).answer.get(0).valueCoding.code, "LA32-8");
        assertEquals(data.item.get(1).item.get(0).item.get(4).answer.get(0).valueCoding.display, "No");
        assertEquals(data.item.get(1).item.get(0).item.get(4).answer.get(0).valueCoding.system,
                "http://loinc.org");
        assertEquals(data.item.get(1).item.get(0).item.get(4).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(5).answer.get(0).valueCoding.code, "LA32-8");
        assertEquals(data.item.get(1).item.get(0).item.get(5).answer.get(0).valueCoding.display, "No");
        assertEquals(data.item.get(1).item.get(0).item.get(5).answer.get(0).valueCoding.system,
                "http://loinc.org");
        assertEquals(data.item.get(1).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54135-9");
        assertEquals(data.item.get(1).item.get(0).item.get(5).linkId, "1.1.6");
        assertEquals(data.item.get(1).item.get(0).item.get(5).text,
        ...
        assertEquals(
                data.item.get(1).item.get(0).item.get(6).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.code, "[in_i]");
        assertEquals(
                data.item.get(1).item.get(0).item.get(6).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.display, "inches");
        assertEquals(
                data.item.get(1).item.get(0).item.get(6).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.system, "http://unitsofmeasure.org");
        assertEquals(
        ...
        assertEquals(
                ...
                "Units");
        assertEquals(data.item.get(1).item.get(0).item.get(6).answer.get(0).item.get(0).linkId,
                "1.1.7.1");
        assertEquals(data.item.get(1).item.get(0).item.get(6).answer.get(0).valueDecimal.toString(),
                "63");
        assertEquals(data.item.get(1).item.get(0).item.get(6).definition,
        ...
        assertEquals(
                data.item.get(1).item.get(0).item.get(7).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.code, "lb");
        assertEquals(
                data.item.get(1).item.get(0).item.get(7).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.display, "pounds");
        assertEquals(
                data.item.get(1).item.get(0).item.get(7).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueCoding.system, "http://unitsofmeasure.org");
        assertEquals(
        ...
        assertEquals(
                ...
                "Units");
        assertEquals(data.item.get(1).item.get(0).item.get(7).answer.get(0).item.get(0).linkId,
                "1.1.8.1");
        assertEquals(data.item.get(1).item.get(0).item.get(7).answer.get(0).valueDecimal.toString(),
                "127");
        assertEquals(data.item.get(1).item.get(0).item.get(7).definition,
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(8).answer.get(0).valueDecimal.toString(),
                "22.5");
        assertEquals(data.item.get(1).item.get(0).item.get(8).definition,
                "http://loinc.org/fhir/DataElement/39156-5");
        assertEquals(data.item.get(1).item.get(0).item.get(8).linkId, "1.1.9");
        assertEquals(data.item.get(1).item.get(0).item.get(8).text, "Body mass index (BMI) [Ratio]");
        assertEquals(data.item.get(1).item.get(0).item.get(9).answer.get(0).valueCoding.code,
                "LA4457-3");
        assertEquals(data.item.get(1).item.get(0).item.get(9).answer.get(0).valueCoding.display,
                "White");
        assertEquals(data.item.get(1).item.get(0).item.get(9).answer.get(0).valueCoding.system,
                "http://loinc.org");
        assertEquals(data.item.get(1).item.get(0).item.get(9).definition,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(1).answer.get(0).valueString,
                "Susan");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(1).definition,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(2).definition,
        ...
        assertEquals(
                data.item.get(2).item.get(0).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "17");
        assertEquals(
                data.item.get(2).item.get(0).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
                data.item.get(2).item.get(0).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).linkId, "2.1.1.4.2.2");
        assertEquals(
                data.item.get(2).item.get(0).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).text, "Age");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(3).definition,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(4).text,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(0).item.get(0).item.get(5).text,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(1).answer.get(0).valueString,
                "Brian");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(1).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "32");
        assertEquals(
                data.item.get(2).item.get(1).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(1).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(data.item.get(2).item.get(1).item.get(1).item.get(0).text, "Disease or Condition");
        assertEquals(
        ...
        assertEquals(data.item.get(2).item.get(1).item.get(1).item.get(1).text, "Age at Diagnosis");
        assertEquals(data.item.get(2).item.get(1).item.get(1).linkId, "2.1.2");
        assertEquals(data.item.get(2).item.get(1).item.get(1).text,
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(1).answer.get(0).valueString,
                "Janet");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(2).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "36");
        assertEquals(
                data.item.get(2).item.get(2).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(2).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(data.item.get(2).item.get(2).item.get(1).item.get(0).text, "Disease or Condition");
        assertEquals(
        ...
        assertEquals(data.item.get(2).item.get(2).item.get(1).item.get(1).text, "Age at Diagnosis");
        assertEquals(data.item.get(2).item.get(2).item.get(1).linkId, "2.1.2");
        assertEquals(data.item.get(2).item.get(2).item.get(1).text,
                "This family member's history of disease");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(1).answer.get(0).valueString,
                "Ian");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(3).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "16");
        assertEquals(
                data.item.get(2).item.get(3).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(3).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(1).answer.get(0).valueString,
                "Helen");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(4).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "15");
        assertEquals(
                data.item.get(2).item.get(4).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(4).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(1).answer.get(0).valueString,
                "Donald");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(5).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "52");
        assertEquals(
                data.item.get(2).item.get(5).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(5).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(1).answer.get(0).valueString,
                "Eric");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(6).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "56");
        assertEquals(
                data.item.get(2).item.get(6).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(6).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(1).answer.get(0).valueString,
                "Fiona");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(7).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueDecimal.toString(), "57");
        assertEquals(
                data.item.get(2).item.get(7).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54141-7");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(7).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(data.item.get(2).item.get(7).item.get(1).item.get(0).text, "Disease or Condition");
        assertEquals(data.item.get(2).item.get(7).item.get(1).linkId, "2.1.2");
        assertEquals(data.item.get(2).item.get(7).item.get(1).text,
                "This family member's history of disease");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(1).answer.get(0).valueString,
                "Bob");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.code, "LA10537-1");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.display, "-- Colon Cancer");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.system, "http://loinc.org");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).definition, "http://loinc.org/fhir/DataElement/54112-8");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).linkId, "2.1.1.4.1.1");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).text, "Cause of Death");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).answer.get(0).valueCoding.code, "LA10400-2");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).answer.get(0).valueCoding.display, "OVER 60");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).answer.get(0).valueCoding.system, "http://loinc.org");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).definition, "http://loinc.org/fhir/DataElement/54113-6");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).linkId, "2.1.1.4.1.2");
        assertEquals(
                data.item.get(2).item.get(8).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        1).text, "Age at Death");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(8).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(data.item.get(2).item.get(8).item.get(1).item.get(0).text, "Disease or Condition");
        assertEquals(
        ...
        assertEquals(data.item.get(2).item.get(8).item.get(1).item.get(1).text, "Age at Diagnosis");
        assertEquals(data.item.get(2).item.get(8).item.get(1).linkId, "2.1.2");
        assertEquals(data.item.get(2).item.get(8).item.get(1).text,
                "This family member's history of disease");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(0).definition,
                "http://loinc.org/fhir/DataElement/54136-7");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(0).linkId, "2.1.1.1");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(0).text, "Relationship to you");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(1).answer.get(0).valueString,
                "Claire");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(1).definition,
                "http://loinc.org/fhir/DataElement/54138-3");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(2).definition,
                "http://loinc.org/fhir/DataElement/54123-5");
        ...
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).item.get(0).answer.get(0).valueString, "Lou Gehrigs");
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).item.get(0).linkId, "2.1.1.4.1.1.1");
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).item.get(0).text, "Please specify");
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.code, "LA10589-2");
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.display, "-- Other/Unexpected");
        assertEquals(
                data.item.get(2).item.get(9).item.get(0).item.get(3).answer.get(0).item.get(0).item.get(
                        0).answer.get(0).valueCoding.system, "http://loinc.org");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(3).definition,
                "http://loinc.org/fhir/DataElement/54139-1");
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(4).definition,
                "http://loinc.org/fhir/DataElement/54121-9");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(4).linkId, "2.1.1.5");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(4).text,
                "Was this person born a twin?");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://loinc.org");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(5).definition,
                "http://loinc.org/fhir/DataElement/54122-7");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(5).linkId, "2.1.1.6");
        assertEquals(data.item.get(2).item.get(9).item.get(0).item.get(5).text,
                "Was this person adopted?");
        ...
        assertEquals(data.status, CodeSystems.QuestionnaireResponseStatus.IN_PROGRESS);
    ...
    @Test
    public void testQuestionnaireResponse3() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaireresponse-example-f201-lifelines.json");
        QuestionnaireResponse data = parser.toFhir(QuestionnaireResponse.class, sourceJson);

        assertEquals(data.author.reference, "Practitioner/f201");
        assertEquals(data.authored.toString(), "2013-06-18T00:00:00+01:00");
        assertEquals(data.id, "f201");
        assertEquals(data.item.get(0).item.get(0).answer.get(0).valueString,
        ...
        assertEquals(data.item.get(1).item.get(1).answer.get(0).valueDate.toString(), "1960-03-13");
        ...
        assertEquals(data.item.get(1).item.get(2).answer.get(0).valueString, "The Netherlands");
        ...
        assertEquals(data.item.get(2).item.get(1).answer.get(0).valueString, "No, but I used to drink");
    ...
    @Test
    public void testQuestionnaireResponse4() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaireresponse-example-bluebook.json");
        QuestionnaireResponse data = parser.toFhir(QuestionnaireResponse.class, sourceJson);

        assertEquals(data.author.reference, "http://hl7.org/fhir/Practitioner/example");
        assertEquals(data.authored.toString(), "2013-02-19T14:15:00+10:00");
        assertEquals(data.id, "bb");
        assertEquals(data.item.get(0).item.get(0).item.get(0).answer.get(0).valueString, "Cathy Jones");
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(1).answer.get(0).valueCoding.code, "f");
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(0).answer.get(0).valueDecimal.toString(),
                "3.25");
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(1).answer.get(0).valueDecimal.toString(),
                "44.3");
        ...
        assertEquals(
                data.item.get(0).item.get(1).item.get(2).answer.get(0).item.get(0).item.get(0).answer.get(
                        0).valueDate.toString(), "1972-11-30");
        assertEquals(
        ...
        assertEquals(
                data.item.get(0).item.get(1).item.get(2).answer.get(0).item.get(0).item.get(1).answer.get(
                        0).valueDate.toString(), "1972-12-11");
        assertEquals(
        ...
        assertEquals(
                ...
                "2nd dose");
        assertEquals(data.item.get(0).item.get(1).item.get(2).answer.get(0).item.get(0).linkId,
                "vitaminKgivenDoses");
        assertEquals(data.item.get(0).item.get(1).item.get(2).answer.get(0).valueCoding.code,
                "INJECTION");
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(3).answer.get(0).item.get(0).answer.get(
                0).valueDate.toString(), "1972-12-04");
        assertEquals(data.item.get(0).item.get(1).item.get(3).answer.get(0).item.get(0).linkId,
                "hepBgivenDate");
        assertEquals(data.item.get(0).item.get(1).item.get(3).answer.get(0).item.get(0).text,
                "Date given");
        assertEquals(data.item.get(0).item.get(1).item.get(3).answer.get(0).valueBoolean, true);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(4).answer.get(0).valueString,
    ...
    @Test
    public void testQuestionnaireResponse5() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaireresponse-example-gcs.json");
        QuestionnaireResponse data = parser.toFhir(QuestionnaireResponse.class, sourceJson);

        assertEquals(data.authored.toString(), "2014-12-11T04:44:16Z");
        ...
        assertEquals(data.item.get(0).answer.get(0).valueCoding.extension.get(0).url,
                "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value");
        assertEquals(
                data.item.get(0).answer.get(0).valueCoding.extension.get(0).valueDecimal.toString(), "4");
        ...
        assertEquals(data.item.get(1).answer.get(0).valueCoding.extension.get(0).url,
                "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value");
        assertEquals(
                data.item.get(1).answer.get(0).valueCoding.extension.get(0).valueDecimal.toString(), "5");
        ...
        assertEquals(data.item.get(2).answer.get(0).valueCoding.display, "Eyes open spontaneously");
        assertEquals(data.item.get(2).answer.get(0).valueCoding.extension.get(0).url,
                "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value");
        assertEquals(
                data.item.get(2).answer.get(0).valueCoding.extension.get(0).valueDecimal.toString(), "4");
