...
public class OrganizationTest {
  ...
  public void testOrganization1() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example.json");
    ...
    assertEquals(data.telecom.get(1).system, CodeSystems.ContactPointSystem.FAX);
    assertEquals(data.telecom.get(1).value, "(+1) 734-677-6622");
    assertEquals(data.telecom.get(2).system, CodeSystems.ContactPointSystem.EMAIL);
  ...
  public void testOrganization2() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-mmanu.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
  ...
  public void testOrganization3() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-gastro.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
  ...
  public void testOrganization4() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-lab.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
  ...
  public void testOrganization5() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-f002-burgers-card.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
    ...
    assertEquals(data.contact.get(0).purpose.coding.get(0).system,
    ...
    assertEquals(data.contact.get(0).telecom.get(1).system, CodeSystems.ContactPointSystem.EMAIL);
    assertEquals(data.contact.get(0).telecom.get(1).value, "cardio@burgersumc.nl");
    assertEquals(data.contact.get(0).telecom.get(2).system, CodeSystems.ContactPointSystem.FAX);
  ...
  public void testOrganization6() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-f201-aumc.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
    ...
    assertEquals(data.address.get(0).use, CodeSystems.AddressUse.WORK);
    ...
    assertEquals(data.contact.get(0).name.use, CodeSystems.NameUse.OFFICIAL);
    assertEquals(data.contact.get(0).telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.contact.get(0).telecom.get(0).use, CodeSystems.ContactPointUse.WORK);
  ...
  public void testOrganization7() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-good-health-care.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
  ...
  public void testOrganization8() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-f001-burgers.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
    ...
    assertEquals(data.address.get(1).use, CodeSystems.AddressUse.WORK);
    ...
    assertEquals(data.contact.get(1).purpose.coding.get(0).system,
        "http://hl7.org/fhir/contactentity-type");
    assertEquals(data.contact.get(1).telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
  ...
  public void testOrganization9() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-insurer.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
  ...
  public void testOrganization10() throws Exception {
    String sourceJson = FileHelper.loadString("organization-example-f203-bumc.json");
    Organization data = parser.toFhir(Organization.class, sourceJson);
