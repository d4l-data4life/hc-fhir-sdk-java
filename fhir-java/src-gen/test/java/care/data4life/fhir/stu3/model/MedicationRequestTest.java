...
public class MedicationRequestTest {
	...
	public void testMedicationRequest1() throws Exception {
		...
		assertEquals(data.dosageInstruction.get(0).additionalInstruction.get(0).coding.get(0).code, "311504000");
		assertEquals(data.dosageInstruction.get(0).additionalInstruction.get(0).coding.get(0).display, "With or after food");
		assertEquals(data.dosageInstruction.get(0).additionalInstruction.get(0).coding.get(0).system, "http://snomed.info/sct");
		assertEquals(data.dosageInstruction.get(0).doseQuantity.code, "TAB");
		assertEquals(data.dosageInstruction.get(0).doseQuantity.system, "http://hl7.org/fhir/v3/orderableDrugForm");
		...
		assertEquals(data.dosageInstruction.get(0).method.coding.get(0).display, "Swallow - dosing instruction imperative (qualifier value)");
		assertEquals(data.dosageInstruction.get(0).method.coding.get(0).system, "http://snomed.info/sct");
		...
		assertEquals(data.dosageInstruction.get(0).route.coding.get(0).system, "http://snomed.info/sct");
		...
		assertEquals(data.dosageInstruction.get(0).timing.code.coding.get(0).system, "http://hl7.org/fhir/v3/GTSAbbreviation");
		...
		assertEquals(data.note.get(0).text, "Chlorthalidone increases urniation so take it in the morning");
