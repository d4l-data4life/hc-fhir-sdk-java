...
public class PatientTest {
  ...
  public void testPatient1() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-xds.json");
    ...
    assertEquals(data.gender, CodeSystems.AdministrativeGender.MALE);
    ...
    assertEquals(data.identifier.get(0).use, CodeSystems.IdentifierUse.USUAL);
  ...
  public void testPatient2() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-f001-pieter.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    assertEquals(data.address.get(0).use, CodeSystems.AddressUse.HOME);
    ...
    assertEquals(data.contact.get(0).name.use, CodeSystems.NameUse.USUAL);
    assertEquals(data.contact.get(0).relationship.get(0).coding.get(0).code, "C");
    assertEquals(data.contact.get(0).relationship.get(0).coding.get(0).system,
        "http://hl7.org/fhir/v2/0131");
    assertEquals(data.contact.get(0).telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.contact.get(0).telecom.get(0).use, CodeSystems.ContactPointUse.MOBILE);
    ...
    assertEquals(data.identifier.get(1).use, CodeSystems.IdentifierUse.USUAL);
    ...
    assertEquals(data.name.get(0).use, CodeSystems.NameUse.USUAL);
    assertEquals(data.telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.telecom.get(0).use, CodeSystems.ContactPointUse.MOBILE);
    assertEquals(data.telecom.get(0).value, "0648352638");
    assertEquals(data.telecom.get(1).system, CodeSystems.ContactPointSystem.EMAIL);
    assertEquals(data.telecom.get(1).use, CodeSystems.ContactPointUse.HOME);
  ...
  public void testPatient3() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-d.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);

    assertEquals(data.active, true);
    assertEquals(data.birthDate.toString(), "1982-08-02");
    assertEquals(data.deceasedBoolean, true);
    assertEquals(data.gender, CodeSystems.AdministrativeGender.FEMALE);
    ...
    assertEquals(data.name.get(0).use, CodeSystems.NameUse.OFFICIAL);
    assertEquals(data.text.status, CodeSystems.NarrativeStatus.GENERATED);
  ...
  public void testPatient4() throws Exception {
    String sourceJson = FileHelper.loadString("patient-genetics-example1.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    assertEquals(data.name.get(0).use, CodeSystems.NameUse.OFFICIAL);
    assertEquals(data.telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.telecom.get(0).use, CodeSystems.ContactPointUse.WORK);
  ...
  public void testPatient5() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-b.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);

    assertEquals(data.active, true);
    assertEquals(data.gender, CodeSystems.AdministrativeGender.OTHER);
    ...
    assertEquals(data.link.get(0).type, CodeSystems.LinkType.SEEALSO);
    assertEquals(data.managingOrganization.display, "ACME Healthcare, Inc");
    assertEquals(data.managingOrganization.reference, "Organization/1");
    ...
    exception.expectMessage("Expected: _gender");
    JSONAssert.assertEquals(sourceJson, json, false);
  }

  @Test
  public void testPatient6() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-c.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
  ...
  public void testPatient7() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-ihe-pcd.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
  ...
  public void testPatient8() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    assertEquals(data.address.get(0).type, CodeSystems.AddressType.BOTH);
    assertEquals(data.address.get(0).use, CodeSystems.AddressUse.HOME);
    ...
    assertEquals(data.contact.get(0).address.type, CodeSystems.AddressType.BOTH);
    assertEquals(data.contact.get(0).address.use, CodeSystems.AddressUse.HOME);
    assertEquals(data.contact.get(0).gender, CodeSystems.AdministrativeGender.FEMALE);
    ...
    assertEquals(data.name.get(1).use, CodeSystems.NameUse.USUAL);
    ...
    assertEquals(data.name.get(2).use, CodeSystems.NameUse.MAIDEN);
    assertEquals(data.telecom.get(0).use, CodeSystems.ContactPointUse.HOME);
    assertTrue(data.telecom.get(1).rank == 1);
    assertEquals(data.telecom.get(1).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.telecom.get(1).use, CodeSystems.ContactPointUse.WORK);
    assertEquals(data.telecom.get(1).value, "(03) 5555 6473");
    assertTrue(data.telecom.get(2).rank == 2);
    assertEquals(data.telecom.get(2).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.telecom.get(2).use, CodeSystems.ContactPointUse.MOBILE);
    assertEquals(data.telecom.get(2).value, "(03) 3410 5613");
    assertEquals(data.telecom.get(3).period.end.toString(), "2014");
    assertEquals(data.telecom.get(3).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.telecom.get(3).use, CodeSystems.ContactPointUse.OLD);
    ...
    exception.expect(AssertionError.class);
    exception.expectMessage("Expected: _birthDate");
    exception.expectMessage("Expected: _family");
    JSONAssert.assertEquals(sourceJson, json, false);
  }

  @Test
  public void testPatient9() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-proband.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
  ...
  public void testPatient10() throws Exception {
    String sourceJson = FileHelper.loadString("patient-example-f201-roel.json");
    Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    assertEquals(data.contact.get(0).relationship.get(0).coding.get(1).system,
        "http://hl7.org/fhir/v2/0131");
    assertEquals(data.contact.get(0).relationship.get(0).coding.get(2).code, "WIFE");
    assertEquals(data.contact.get(0).relationship.get(0).coding.get(2).system,
        "http://hl7.org/fhir/v3/RoleCode");
    assertEquals(data.contact.get(0).telecom.get(0).system, CodeSystems.ContactPointSystem.PHONE);
    assertEquals(data.contact.get(0).telecom.get(0).use, CodeSystems.ContactPointUse.HOME);
    ...
    assertEquals(data.identifier.get(1).use, CodeSystems.IdentifierUse.OFFICIAL);
