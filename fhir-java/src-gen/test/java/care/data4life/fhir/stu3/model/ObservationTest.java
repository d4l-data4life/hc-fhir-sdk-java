...
public class ObservationTest {
    ...
    public void testObservation1() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-genetics-1.json");
        ...
        assertEquals(data.extension.get(1).valueCodeableConcept.coding.get(0).system,
        ...
        assertEquals(data.extension.get(3).url,
        ...
        assertEquals(data.extension.get(3).valueCodeableConcept.coding.get(0).system,
                "http://loinc.org");
        ...
        assertEquals(data.status, CodeSystems.ObservationStatus.FINAL);
    ...
    public void testObservation2() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-bmd.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
        ...
        assertEquals(data.performer.get(0).reference,
    ...
    public void testObservation3() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-respiratory-rate.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation4() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation5() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-haplotype2.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
        ...
        assertEquals(data.extension.get(0).valueCodeableConcept.coding.get(0).system,
                "http://www.genenames.org");
        assertEquals(data.extension.get(1).url,
        ...
        assertEquals(data.related.get(0).type, CodeSystems.ObservationRelationshipType.DERIVED_FROM);
        assertEquals(data.related.get(1).target.reference, "Sequence/example-pgx-2");
        assertEquals(data.related.get(1).type, CodeSystems.ObservationRelationshipType.DERIVED_FROM);
        assertEquals(data.specimen.display, "Molecular Specimen ID: MLD45-Z4-1234");
        assertEquals(data.specimen.reference, "Specimen/genetics-example1-somatic");
        assertEquals(data.status, CodeSystems.ObservationStatus.UNKNOWN);
    ...
    public void testObservation6() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-mbp.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation7() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-bmi.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation8() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-body-height.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation9() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-eye-color.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
    ...
    public void testObservation10() throws Exception {
        String sourceJson = FileHelper.loadString("observation-example-body-temperature.json");
        Observation data = parser.toFhir(Observation.class, sourceJson);
