...
public class ProcedureRequestTest {
    ...
    public void testProcedureRequest1() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-lipid.json");
        ...
        assertEquals(data.identifier.get(0).type.coding.get(0).system,
        ...
        assertEquals(data.intent, CodeSystems.RequestIntent.ORIGINAL_ORDER);
    ...
    public void testProcedureRequest2() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example4.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.intent, CodeSystems.RequestIntent.PLAN);
    ...
    public void testProcedureRequest3() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-edu.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.status, CodeSystems.RequestStatus.COMPLETED);
    ...
    public void testProcedureRequest4() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-pt.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.reasonCode.get(0).text,
    ...
    public void testProcedureRequest5() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-genetics-example-1.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
    ...
    public void testProcedureRequest6() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-di.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
    ...
    public void testProcedureRequest7() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-subrequest.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.intent, CodeSystems.RequestIntent.INSTANCE_ORDER);
        assertEquals(data.occurrenceDateTime.toString(), "2013-05-08T09:33:27+07:00");
    ...
    public void testProcedureRequest8() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example2.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
    ...
    public void testProcedureRequest9() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example3.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.intent, CodeSystems.RequestIntent.ORDER);
        assertEquals(data.priority, CodeSystems.RequestPriority.STAT);
    ...
    public void testProcedureRequest10() throws Exception {
        String sourceJson = FileHelper.loadString("procedurerequest-example-ambulation.json");
        ProcedureRequest data = parser.toFhir(ProcedureRequest.class, sourceJson);
        ...
        assertEquals(data.requester.agent.reference,
