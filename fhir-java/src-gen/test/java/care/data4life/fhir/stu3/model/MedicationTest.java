...
public class MedicationTest {
    ...
    public void testMedication1() throws Exception {
        ...
        assertEquals(data.fhirPackage.content.get(0).itemCodeableConcept.coding.get(0).code,
                "325072002");
        assertEquals(data.fhirPackage.content.get(0).itemCodeableConcept.coding.get(0).display,
                "Insulin Aspart (substance)");
        assertEquals(data.fhirPackage.content.get(0).itemCodeableConcept.coding.get(0).system,
        ...
        assertEquals(data.ingredient.get(0).itemCodeableConcept.coding.get(0).display,
                "Insulin Aspart (substance)");
        assertEquals(data.ingredient.get(0).itemCodeableConcept.coding.get(0).system,
                "http://snomed.info/sct");
    ...
    public void testMedication2() throws Exception {
        ...
        assertEquals(data.ingredient.get(0).amount.denominator.system,
    ...
    public void testMedication4() throws Exception {
        ...
        assertEquals(data.form.coding.get(0).display,
    ...
    public void testMedication6() throws Exception {
        ...
        assertEquals(data.ingredient.get(1).itemCodeableConcept.coding.get(0).display,
                "Sodium Chloride 0.9% injectable solution");
        assertEquals(data.ingredient.get(1).itemCodeableConcept.coding.get(0).system,
                "http://www.nlm.nih.gov/research/umls/rxnorm");
        assertEquals(data.isBrand, false);
        assertEquals(data.text.status, CodeSystems.NarrativeStatus.GENERATED);
    ...
    public void testMedication8() throws Exception {
        ...
        assertEquals(data.fhirPackage.container.coding.get(0).display,
    ...
    public void testMedication9() throws Exception {
        ...
        assertEquals(data.ingredient.get(0).amount.denominator.code,
