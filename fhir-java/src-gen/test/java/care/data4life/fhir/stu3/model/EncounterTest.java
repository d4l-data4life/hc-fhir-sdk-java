 ...
 * <p>
 * <p>
 * "Generated from FHIR 3.0.1.11917 on 2020-10-21
 */
public class EncounterTest {
    ...
    public void testEncounter1() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-home.json");
        ...
        assertEquals(data.clazz.system, "http://hl7.org/fhir/v3/ActCode");
    ...
    public void testEncounter2() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f201-20130404.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.reason.get(0).text, "The patient had fever peaks over the last couple of days. He is worried about these peaks.");
    ...
    public void testEncounter3() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f003-abscess.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.priority.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).coding.get(0).code, "18099001");
        assertEquals(data.reason.get(0).coding.get(0).display, "Retropharyngeal abscess");
        assertEquals(data.reason.get(0).coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).extension.get(0).url, "http://hl7.org/fhir/StructureDefinition/encounter-primaryDiagnosis");
        assertTrue(data.reason.get(0).extension.get(0).valuePositiveInt == 1);
    ...
    public void testEncounter4() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter5() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f002-lung.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.priority.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).coding.get(0).code, "34068001");
        assertEquals(data.reason.get(0).coding.get(0).display, "Partial lobectomy of lung");
        assertEquals(data.reason.get(0).coding.get(0).system, "http://snomed.info/sct");
    ...
    public void testEncounter6() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f203-20130311.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);

        assertEquals(data.account.get(0).reference, "Account/example");
        assertEquals(data.appointment.reference, "Appointment/example");
        assertEquals(data.clazz.code, "IMP");
        assertEquals(data.clazz.display, "inpatient encounter");
        assertEquals(data.clazz.system, "http://hl7.org/fhir/v3/ActCode");
        assertEquals(data.diagnosis.get(0).condition.reference, "Condition/stroke");
        assertTrue(data.diagnosis.get(0).rank == 1);
        assertEquals(data.diagnosis.get(0).role.coding.get(0).code, "AD");
        assertEquals(data.diagnosis.get(0).role.coding.get(0).display, "Admission diagnosis");
        assertEquals(data.diagnosis.get(0).role.coding.get(0).system, "http://hl7.org/fhir/diagnosis-role");
        assertEquals(data.diagnosis.get(1).condition.reference, "Condition/f201");
        assertEquals(data.diagnosis.get(1).role.coding.get(0).code, "DD");
        assertEquals(data.diagnosis.get(1).role.coding.get(0).display, "Discharge diagnosis");
        assertEquals(data.diagnosis.get(1).role.coding.get(0).system, "http://hl7.org/fhir/diagnosis-role");
        ...
        assertEquals(data.hospitalization.specialArrangement.get(0).coding.get(0).system, "http://hl7.org/fhir/encounter-special-arrangements");
        ...
        assertEquals(data.hospitalization.specialCourtesy.get(0).coding.get(0).system, "http://hl7.org/fhir/v3/EncounterSpecialCourtesy");
        assertEquals(data.id, "f203");
        assertEquals(data.identifier.get(0).use, CodeSystemIdentifierUse.TEMP);
        assertEquals(data.identifier.get(0).value, "Encounter_Roel_20130311");
        assertEquals(data.incomingReferral.get(0).reference, "ReferralRequest/example");
        assertEquals(data.partOf.reference, "Encounter/f203");
        assertEquals(data.participant.get(0).individual.reference, "Practitioner/f201");
        assertEquals(data.participant.get(0).type.get(0).coding.get(0).code, "PART");
        assertEquals(data.participant.get(0).type.get(0).coding.get(0).system, "http://hl7.org/fhir/v3/ParticipationType");
        ...
        assertEquals(data.priority.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).text, "The patient seems to suffer from bilateral pneumonia and renal insufficiency, most likely due to chemotherapy.");
    ...
    public void testEncounter7() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-xcda.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.reason.get(0).coding.get(0).code, "T-D8200");
        assertEquals(data.reason.get(0).coding.get(0).display, "Arm");
        assertEquals(data.reason.get(0).coding.get(0).system, "http://ihe.net/xds/connectathon/eventCodes");
        assertEquals(data.status, CodeSystemEncounterStatus.FINISHED);
    ...
    public void testEncounter8() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f202-20130128.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.priority.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).extension.get(0).url, "http://hl7.org/fhir/StructureDefinition/encounter-primaryDiagnosis");
        assertTrue(data.reason.get(0).extension.get(0).valuePositiveInt == 2);
        assertEquals(data.reason.get(0).text, "The patient is treated for a tumor.");
        assertEquals(data.serviceProvider.reference, "Organization/f201");
        assertEquals(data.status, CodeSystemEncounterStatus.FINISHED);
        assertEquals(data.subject.display, "Roel");
        assertEquals(data.subject.reference, "Patient/f201");
    ...
    public void testEncounter9() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-emerg.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);

        assertEquals(data.classHistory.get(0).clazz.code, "EMER");
        assertEquals(data.classHistory.get(0).clazz.display, "emergency");
        assertEquals(data.classHistory.get(0).clazz.system, "http://hl7.org/fhir/v3/ActCode");
        ...
        assertEquals(data.classHistory.get(1).clazz.system, "http://hl7.org/fhir/v3/ActCode");
        ...
        assertEquals(data.hospitalization.admitSource.coding.get(0).system, "http://hl7.org/fhir/admit-source");
    ...
    public void testEncounter10() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/encounter-example-f001-heart.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
        ...
        assertEquals(data.priority.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.reason.get(0).coding.get(0).code, "34068001");
        assertEquals(data.reason.get(0).coding.get(0).display, "Heart valve replacement");
        assertEquals(data.reason.get(0).coding.get(0).system, "http://snomed.info/sct");
