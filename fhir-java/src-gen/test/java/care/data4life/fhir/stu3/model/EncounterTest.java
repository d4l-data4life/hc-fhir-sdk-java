...
public class EncounterTest {
    ...
    public void testEncounter1() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-home.json");
    ...
    public void testEncounter2() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f201-20130404.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter3() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f003-abscess.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter4() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter5() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f002-lung.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter6() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f203-20130311.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter7() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-xcda.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter8() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f202-20130128.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter9() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-emerg.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
    ...
    public void testEncounter10() throws Exception {
        String sourceJson = FileHelper.loadString("encounter-example-f001-heart.json");
        Encounter data = parser.toFhir(Encounter.class, sourceJson);
