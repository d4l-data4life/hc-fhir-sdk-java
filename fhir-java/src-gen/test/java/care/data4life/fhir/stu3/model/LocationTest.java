...
public class LocationTest {
    ...
    public void testLocation1() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example.json");
        ...
        assertEquals(data.extension.get(0).url, "http://hl7.org/fhir/StructureDefinition/location-alias");
        assertEquals(data.extension.get(0).valueString, "Burgers University Medical Center, South Wing, second floor");
        assertEquals(data.extension.get(1).url, "http://hl7.org/fhir/StructureDefinition/location-alias");
        assertEquals(data.extension.get(1).valueString, "BU MC, SW, F2");
        ...
        assertEquals(data.physicalType.coding.get(0).system, "http://hl7.org/fhir/location-physical-type");
    ...
    public void testLocation2() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example-room.json");
        Location data = parser.toFhir(Location.class, sourceJson);
        ...
        assertEquals(data.operationalStatus.system, "http://hl7.org/fhir/v2/0116");
        ...
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.type.coding.get(0).code, "RNEU");
        assertEquals(data.type.coding.get(0).display, "Neuroradiology unit");
        assertEquals(data.type.coding.get(0).system, "http://hl7.org/fhir/v3/RoleCode");
    ...
    public void testLocation3() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example-ambulance.json");
        Location data = parser.toFhir(Location.class, sourceJson);
        ...
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.type.coding.get(0).code, "AMB");
        assertEquals(data.type.coding.get(0).display, "Ambulance");
        assertEquals(data.type.coding.get(0).system, "http://hl7.org/fhir/v3/RoleCode");
    ...
    public void testLocation4() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example-ukpharmacy.json");
        Location data = parser.toFhir(Location.class, sourceJson);
        ...
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.type.coding.get(0).code, "PHARM");
        assertEquals(data.type.coding.get(0).display, "Pharmacy");
        assertEquals(data.type.coding.get(0).system, "http://hl7.org/fhir/v3/RoleCode");
    ...
    public void testLocation5() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example-patients-home.json");
        Location data = parser.toFhir(Location.class, sourceJson);
        ...
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.type.coding.get(0).code, "PTRES");
        assertEquals(data.type.coding.get(0).display, "Patient's Residence");
        assertEquals(data.type.coding.get(0).system, "http://hl7.org/fhir/v3/RoleCode");
    ...
    public void testLocation6() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/location-example-hl7hq.json");
        Location data = parser.toFhir(Location.class, sourceJson);
        ...
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.type.coding.get(0).code, "SLEEP");
        assertEquals(data.type.coding.get(0).display, "Sleep disorders unit");
        assertEquals(data.type.coding.get(0).system, "http://hl7.org/fhir/v3/RoleCode");
