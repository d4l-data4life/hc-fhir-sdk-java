...
public class QuestionnaireTest {
	...
	public void testQuestionnaire1() throws Exception {
		...
		assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.CHOICE);
		...
		assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).type, CodeSystems.QuestionnaireItemType.CHOICE);
		...
		assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.CHOICE);
		...
		assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).type, CodeSystems.QuestionnaireItemType.CHOICE);
		assertEquals(data.item.get(0).item.get(0).item.get(0).linkId, "1.1.1");
		assertEquals(data.item.get(0).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.GROUP);
		...
		assertEquals(data.item.get(1).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.CHOICE);
	...
	public void testQuestionnaire4() throws Exception {
		...
		assertEquals(data.item.get(0).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.STRING);
		...
		assertEquals(data.item.get(0).item.get(0).item.get(1).type, CodeSystems.QuestionnaireItemType.CHOICE);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(0).type, CodeSystems.QuestionnaireItemType.DECIMAL);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(1).type, CodeSystems.QuestionnaireItemType.DECIMAL);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.DATETIME);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(1).type, CodeSystems.QuestionnaireItemType.DATETIME);
		assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).linkId, "vitaminKgivenDoses");
		assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).type, CodeSystems.QuestionnaireItemType.GROUP);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(2).type, CodeSystems.QuestionnaireItemType.CHOICE);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(3).item.get(0).type, CodeSystems.QuestionnaireItemType.DATE);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(3).type, CodeSystems.QuestionnaireItemType.BOOLEAN);
		...
		assertEquals(data.item.get(0).item.get(1).item.get(4).type, CodeSystems.QuestionnaireItemType.STRING);
