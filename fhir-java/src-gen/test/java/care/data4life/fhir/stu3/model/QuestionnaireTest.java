...
public class QuestionnaireTest {
    ...
    public void testQuestionnaire1() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaire-example.json");
        ...
        assertEquals(data.item.get(0).item.get(0).code.get(0).system,
                "http://example.org/system/code/questions");
        assertEquals(data.item.get(0).item.get(0).item.get(0).code.get(0).code, "CARDIAL");
        assertEquals(data.item.get(0).item.get(0).item.get(0).code.get(0).system,
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(0).enableWhen.get(0).answerCoding.system,
                "http://hl7.org/fhir/v2/0136");
        assertEquals(data.item.get(0).item.get(0).item.get(0).enableWhen.get(0).question, "1.1");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).code.get(0).code,
                "COMORBCAR");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).code.get(0).system,
                "http://example.org/system/code/questions");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).code.get(0).code,
                "COMCAR00");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://example.org/system/code/questions");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).code.get(1).code,
                "194828000");
        assertEquals(
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).linkId,
                "1.1.1.1.1");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).options.reference,
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).code.get(0).code,
                "22298006");
        assertEquals(
        ...
        assertEquals(
                ...
                "http://snomed.info/sct");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).linkId,
                "1.1.1.1.2");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).options.reference,
                "http://hl7.org/fhir/ValueSet/yesnodontknow");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).prefix, "1.1.2");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).item.get(1).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).linkId, "1.1.1.1");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).options.reference,
                "http://hl7.org/fhir/ValueSet/yesnodontknow");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).prefix, "1.1");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).code.get(0).code,
                "COMORBVAS");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).code.get(0).system,
                "http://example.org/system/code/questions");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).linkId, "1.1.1.2");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).options.reference,
                "http://hl7.org/fhir/ValueSet/yesnodontknow");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).prefix, "1.2");
        assertEquals(data.item.get(0).item.get(0).item.get(0).item.get(1).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).item.get(0).item.get(0).linkId, "1.1.1");
        assertEquals(data.item.get(0).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.GROUP);
        assertEquals(data.item.get(0).item.get(0).linkId, "1.1");
        assertEquals(data.item.get(0).item.get(0).options.reference,
                "http://hl7.org/fhir/ValueSet/yesnodontknow");
        assertEquals(data.item.get(0).item.get(0).prefix, "1");
        assertEquals(data.item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).linkId, "1");
        assertEquals(data.item.get(0).type, CodeSystems.QuestionnaireItemType.GROUP);
        ...
        assertEquals(data.item.get(1).item.get(0).code.get(0).system,
                "http://example.org/system/code/sections");
        ...
        assertEquals(data.item.get(1).item.get(0).item.get(0).code.get(0).system,
                "http://example.org/system/code/questions");
        assertEquals(data.item.get(1).item.get(0).item.get(0).linkId, "2.1.2");
        assertEquals(data.item.get(1).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(1).item.get(0).linkId, "2.1");
        assertEquals(data.item.get(1).item.get(0).type, CodeSystems.QuestionnaireItemType.GROUP);
        assertEquals(data.item.get(1).linkId, "2");
        assertEquals(data.item.get(1).type, CodeSystems.QuestionnaireItemType.GROUP);
        assertEquals(data.status, CodeSystems.PublicationStatus.DRAFT);
        assertEquals(data.subjectType.get(0), "Patient");
    ...
    public void testQuestionnaire2() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaire-example-f201-lifelines.json");
        Questionnaire data = parser.toFhir(Questionnaire.class, sourceJson);
        ...
        assertEquals(data.item.get(0).type, CodeSystems.QuestionnaireItemType.BOOLEAN);
        assertEquals(data.item.get(1).item.get(0).linkId, "2.1");
        assertEquals(data.item.get(1).item.get(0).text, "What is your gender?");
        assertEquals(data.item.get(1).item.get(0).type, CodeSystems.QuestionnaireItemType.STRING);
        ...
        assertEquals(data.item.get(1).item.get(1).type, CodeSystems.QuestionnaireItemType.DATE);
        ...
        assertEquals(data.item.get(1).item.get(2).type, CodeSystems.QuestionnaireItemType.STRING);
        ...
        assertEquals(data.item.get(1).item.get(3).type, CodeSystems.QuestionnaireItemType.STRING);
        assertEquals(data.item.get(1).linkId, "2");
        ...
        assertEquals(data.item.get(2).item.get(0).type, CodeSystems.QuestionnaireItemType.BOOLEAN);
        assertEquals(data.item.get(2).item.get(1).linkId, "3.2");
        assertEquals(data.item.get(2).item.get(1).text, "Do you drink alchohol?");
        assertEquals(data.item.get(2).item.get(1).type, CodeSystems.QuestionnaireItemType.BOOLEAN);
        assertEquals(data.item.get(2).linkId, "3");
        assertEquals(data.item.get(2).text, "Intoxications");
        assertEquals(data.item.get(2).type, CodeSystems.QuestionnaireItemType.GROUP);
        assertEquals(data.status, CodeSystems.PublicationStatus.ACTIVE);
        assertEquals(data.subjectType.get(0), "Patient");
        assertEquals(data.text.status, CodeSystems.NarrativeStatus.GENERATED);
    ...
    public void testQuestionnaire3() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaire-example-gcs.json");
        Questionnaire data = parser.toFhir(Questionnaire.class, sourceJson);
        ...
        assertEquals(data.item.get(0).type, CodeSystems.QuestionnaireItemType.CHOICE);
        ...
        assertEquals(data.item.get(1).type, CodeSystems.QuestionnaireItemType.CHOICE);
        ...
        assertEquals(data.item.get(2).type, CodeSystems.QuestionnaireItemType.CHOICE);
    ...
    public void testQuestionnaire4() throws Exception {
        String sourceJson = FileHelper.loadString("questionnaire-example-bluebook.json");
        Questionnaire data = parser.toFhir(Questionnaire.class, sourceJson);
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.STRING);
        ...
        assertEquals(data.item.get(0).item.get(0).item.get(1).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        assertEquals(data.item.get(0).item.get(0).linkId, "group");
        assertEquals(data.item.get(0).item.get(0).type, CodeSystems.QuestionnaireItemType.GROUP);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(0).type,
                CodeSystems.QuestionnaireItemType.DECIMAL);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(1).type,
                CodeSystems.QuestionnaireItemType.DECIMAL);
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).enableWhen.get(0).hasAnswer,
                true);
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).enableWhen.get(0).question,
                "vitaminKgiven");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(0).linkId,
                "vitaminiKDose1");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(0).text, "1st dose");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(0).type,
                CodeSystems.QuestionnaireItemType.DATETIME);
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(1).linkId,
                "vitaminiKDose2");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(1).text, "2nd dose");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).item.get(1).type,
                CodeSystems.QuestionnaireItemType.DATETIME);
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).linkId, "vitaminKgivenDoses");
        assertEquals(data.item.get(0).item.get(1).item.get(2).item.get(0).type,
                CodeSystems.QuestionnaireItemType.GROUP);
        assertEquals(data.item.get(0).item.get(1).item.get(2).linkId, "vitaminKgiven");
        assertEquals(data.item.get(0).item.get(1).item.get(2).option.get(0).valueCoding.code,
                "INJECTION");
        assertEquals(data.item.get(0).item.get(1).item.get(2).option.get(1).valueCoding.code,
                "INTRAVENOUS");
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(2).type,
                CodeSystems.QuestionnaireItemType.CHOICE);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(3).item.get(0).type,
                CodeSystems.QuestionnaireItemType.DATE);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(3).type,
                CodeSystems.QuestionnaireItemType.BOOLEAN);
        ...
        assertEquals(data.item.get(0).item.get(1).item.get(4).type,
                CodeSystems.QuestionnaireItemType.STRING);
        ...
        assertEquals(data.item.get(0).item.get(1).type, CodeSystems.QuestionnaireItemType.GROUP);
