...
public class ReferralRequestTest {
    ...
    public void testReferralRequest1() throws Exception {
        ...
        assertEquals(data.definition.get(0).display,
        ...
        assertEquals(data.recipient.get(0).reference,
        ...
        assertEquals(data.serviceRequested.get(0).coding.get(0).display,
        ...
        assertEquals(data.specialty.coding.get(0).system,
