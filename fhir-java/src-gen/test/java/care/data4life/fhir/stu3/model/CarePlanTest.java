...
public class CarePlanTest {
    ...
    public void testCarePlan1() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-f002-lung.json");
        ...
        assertEquals(data.intent, CodeSystemCarePlanIntent.PLAN);
        assertEquals(data.period.end.toString(), "2013-07-07");
        assertEquals(data.period.start.toString(), "2011-07-06");
        assertEquals(data.status, CodeSystemCarePlanStatus.COMPLETED);
    ...
    public void testCarePlan2() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-f202-malignancy.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
        ...
        assertEquals(data.intent, CodeSystemCarePlanIntent.PLAN);
        assertEquals(data.status, CodeSystemCarePlanStatus.ACTIVE);
    ...
    public void testCarePlan3() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-obesity-narrative.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan4() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan5() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-f201-renal.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
        ...
        assertEquals(data.intent, CodeSystemCarePlanIntent.PROPOSAL);
        assertEquals(data.period.end.toString(), "2013-03-13");
        assertEquals(data.period.start.toString(), "2013-03-11");
        assertEquals(data.status, CodeSystemCarePlanStatus.DRAFT);
        assertEquals(data.subject.display, "Roel");
        assertEquals(data.subject.reference, "Patient/f201");
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
    ...
    public void testCarePlan6() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-GPVisit.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan7() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-integrated.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan8() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-f003-pharynx.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan9() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-f001-heart.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    public void testCarePlan10() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/careplan-example-pregnancy.json");
        CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
