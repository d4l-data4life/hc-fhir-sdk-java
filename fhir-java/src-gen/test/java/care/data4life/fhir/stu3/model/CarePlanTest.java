...
public class CarePlanTest {
	...
	public void testCarePlan1() throws Exception {
		...
		assertEquals(data.activity.get(0).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
	...
	public void testCarePlan2() throws Exception {
		...
		assertEquals(data.activity.get(0).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
	...
	public void testCarePlan4() throws Exception {
		...
		assertEquals(data.activity.get(0).detail.status, CodeSystems.CarePlanActivityStatus.COMPLETED);
		assertEquals(data.activity.get(0).detail.statusReason, "Achieved weight loss to mitigate diabetes risk.");
	...
	public void testCarePlan5() throws Exception {
		...
		assertEquals(data.activity.get(1).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
	...
	public void testCarePlan7() throws Exception {
		...
		assertEquals(data.activity.get(0).detail.status, CodeSystems.CarePlanActivityStatus.NOT_STARTED);
		...
		assertEquals(data.activity.get(1).detail.status, CodeSystems.CarePlanActivityStatus.NOT_STARTED);
		...
		assertEquals(data.activity.get(2).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(2).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		assertEquals(data.activity.get(3).detail.category.coding.get(0).code, "other");
		assertEquals(data.activity.get(3).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(3).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		...
		assertEquals(data.activity.get(4).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(4).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		...
		assertEquals(data.activity.get(5).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		assertEquals(data.activity.get(5).detail.description, "Eve will us a calendar to check off after medications are taken");
		...
		assertEquals(data.activity.get(5).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		assertEquals(data.activity.get(6).detail.category.coding.get(0).code, "other");
		assertEquals(data.activity.get(6).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(6).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		...
		assertEquals(data.activity.get(7).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(7).detail.status, CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
		...
		assertEquals(data.activity.get(8).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
		...
		assertEquals(data.activity.get(9).detail.category.coding.get(0).system, "http://hl7.org/fhir/care-plan-activity-category");
	...
	public void testCarePlan10() throws Exception {
		...
		assertEquals(data.activity.get(2).detail.status, CodeSystems.CarePlanActivityStatus.NOT_STARTED);
		...
		assertEquals(data.activity.get(3).detail.status, CodeSystems.CarePlanActivityStatus.NOT_STARTED);
