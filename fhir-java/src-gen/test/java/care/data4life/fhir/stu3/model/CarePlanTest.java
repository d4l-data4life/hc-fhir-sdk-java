...
public class CarePlanTest {
  ...
  public void testCarePlan1() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-f002-lung.json");
    ...
    assertEquals(data.activity.get(0).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(0).detail.code.coding.get(0).code, "359615001");
    assertEquals(data.activity.get(0).detail.code.coding.get(0).display,
    ...
    assertEquals(data.activity.get(0).detail.status, CodeSystems.CarePlanActivityStatus.COMPLETED);
    ...
    assertEquals(data.identifier.get(0).system,
    ...
    assertEquals(data.intent, CodeSystems.CarePlanIntent.PLAN);
    assertEquals(data.period.end.toString(), "2013-07-07");
    assertEquals(data.period.start.toString(), "2011-07-06");
    assertEquals(data.status, CodeSystems.CarePlanStatus.COMPLETED);
  ...
  public void testCarePlan2() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-f202-malignancy.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    assertEquals(data.activity.get(0).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    ...
    assertEquals(data.intent, CodeSystems.CarePlanIntent.PLAN);
    assertEquals(data.status, CodeSystems.CarePlanStatus.ACTIVE);
  ...
  public void testCarePlan3() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-obesity-narrative.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
  ...
  public void testCarePlan4() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    assertEquals(data.activity.get(0).detail.status, CodeSystems.CarePlanActivityStatus.COMPLETED);
    assertEquals(data.activity.get(0).detail.statusReason,
        "Achieved weight loss to mitigate diabetes risk.");
    assertEquals(data.activity.get(0).outcomeCodeableConcept.get(0).coding.get(0).code,
        "161832001");
    assertEquals(data.activity.get(0).outcomeCodeableConcept.get(0).coding.get(0).display,
        "Progressive weight loss");
    assertEquals(data.activity.get(0).outcomeCodeableConcept.get(0).coding.get(0).system,
  ...
  public void testCarePlan5() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-f201-renal.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    assertEquals(data.activity.get(1).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    ...
    assertEquals(data.activity.get(1).detail.status, CodeSystems.CarePlanActivityStatus.COMPLETED);
    ...
    assertEquals(data.intent, CodeSystems.CarePlanIntent.PROPOSAL);
    assertEquals(data.period.end.toString(), "2013-03-13");
    assertEquals(data.period.start.toString(), "2013-03-11");
    assertEquals(data.status, CodeSystems.CarePlanStatus.DRAFT);
    assertEquals(data.subject.display, "Roel");
    assertEquals(data.subject.reference, "Patient/f201");
    assertEquals(data.text.status, CodeSystems.NarrativeStatus.GENERATED);
  ...
  public void testCarePlan6() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-GPVisit.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    assertEquals(data.activity.get(0).detail.prohibited, false);
    assertEquals(data.activity.get(0).detail.scheduledPeriod.end.toString(),
        "2013-01-01T10:50:00+00:00");
    assertEquals(data.activity.get(0).detail.scheduledPeriod.start.toString(),
    ...
    assertEquals(data.activity.get(1).detail.prohibited, false);
    assertEquals(data.activity.get(1).detail.status, CodeSystems.CarePlanActivityStatus.SCHEDULED);
    assertEquals(data.addresses.get(0).display, "obesity");
    assertEquals(data.addresses.get(0).reference, "#p1");
    assertEquals(data.careTeam.get(0).reference, "#careteam");
    assertEquals(data.contained.get(0).id, "p1");
  ...
  public void testCarePlan7() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-integrated.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);

    assertEquals(data.activity.get(0).detail.category.coding.get(0).code, "other");
    assertEquals(data.activity.get(0).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(0).detail.description,
        "Eve will review photos of high and low density foods and share with her parents");
    assertEquals(data.activity.get(0).detail.extension.get(0).url,
    ...
    assertEquals(data.activity.get(0).detail.status,
        CodeSystems.CarePlanActivityStatus.NOT_STARTED);
    assertEquals(data.activity.get(0).progress.get(0).text,
    ...
    assertEquals(data.activity.get(1).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(1).detail.description,
        "Eve will ask her dad to asist her to put the head of her bed on blocks");
    assertEquals(data.activity.get(1).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(1).detail.status,
        CodeSystems.CarePlanActivityStatus.NOT_STARTED);
    assertEquals(data.activity.get(1).progress.get(0).text,
    ...
    assertEquals(data.activity.get(2).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(2).detail.description,
        "Eve will reduce her intake of coffee and chocolate");
    assertEquals(data.activity.get(2).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(2).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    assertEquals(data.activity.get(3).detail.category.coding.get(0).code, "other");
    assertEquals(data.activity.get(3).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(3).detail.description,
        "Eve will walk her friend's dog up and down a big hill 15-30 minutes 3 days a week");
    assertEquals(data.activity.get(3).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(3).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    assertEquals(data.activity.get(3).progress.get(0).text,
    ...
    assertEquals(data.activity.get(4).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(4).detail.description,
        "Eve will walk 3 blocks to her parents house twice a week");
    assertEquals(data.activity.get(4).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(4).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    ...
    assertEquals(data.activity.get(4).progress.get(1).text,
    ...
    assertEquals(data.activity.get(5).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(5).detail.description,
        "Eve will us a calendar to check off after medications are taken");
    assertEquals(data.activity.get(5).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(5).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    assertEquals(data.activity.get(6).detail.category.coding.get(0).code, "other");
    assertEquals(data.activity.get(6).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(6).detail.description,
        "Eve will use her lights MWF after her shower for 3 minutes");
    assertEquals(data.activity.get(6).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(6).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    assertEquals(data.activity.get(6).progress.get(0).text,
    ...
    assertEquals(data.activity.get(6).progress.get(1).text,
    ...
    assertEquals(data.activity.get(7).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(7).detail.description,
        "Eve will use a calendar of a chart to help her remember when to take her medications");
    assertEquals(data.activity.get(7).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(7).detail.status,
        CodeSystems.CarePlanActivityStatus.IN_PROGRESS);
    assertEquals(data.activity.get(7).progress.get(0).text,
    ...
    assertEquals(data.activity.get(8).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(8).detail.description,
        "Eve will start using stretch bands and one step 2 days a week Mon/Wed 6-7am and maybe Friday afternoon");
    assertEquals(data.activity.get(8).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(8).detail.status, CodeSystems.CarePlanActivityStatus.ON_HOLD);
    ...
    assertEquals(data.activity.get(8).progress.get(1).text,
    ...
    assertEquals(data.activity.get(9).detail.category.coding.get(0).system,
        "http://hl7.org/fhir/care-plan-activity-category");
    assertEquals(data.activity.get(9).detail.description,
        "Eve will match a printed medication worksheet with the medication bottles at home");
    assertEquals(data.activity.get(9).detail.extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/RevisionDate");
    ...
    assertEquals(data.activity.get(9).detail.status, CodeSystems.CarePlanActivityStatus.COMPLETED);
  ...
  public void testCarePlan8() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-f003-pharynx.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
  ...
  public void testCarePlan9() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-f001-heart.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
  ...
  public void testCarePlan10() throws Exception {
    String sourceJson = FileHelper.loadString("careplan-example-pregnancy.json");
    CarePlan data = parser.toFhir(CarePlan.class, sourceJson);
    ...
    assertEquals(data.activity.get(1).detail.code.coding.get(0).system,
    ...
    assertEquals(data.activity.get(1).detail.prohibited, false);
    assertEquals(data.activity.get(1).detail.scheduledTiming.repeat.boundsPeriod.end.toString(),
        "2013-02-28");
    assertEquals(data.activity.get(1).detail.scheduledTiming.repeat.boundsPeriod.start.toString(),
        "2013-02-14");
    assertEquals(data.activity.get(1).detail.status, CodeSystems.CarePlanActivityStatus.SCHEDULED);
    assertEquals(data.activity.get(1).extension.get(0).url,
        "http://example.org/fhir/StructureDefinition/careplan#andetails");
    assertEquals(data.activity.get(1).extension.get(0).valueUri,
    ...
    assertEquals(data.activity.get(2).detail.code.coding.get(0).system,
        "http://example.org/mySystem");
    ...
    assertEquals(data.activity.get(2).detail.prohibited, false);
    assertEquals(data.activity.get(2).detail.scheduledTiming.repeat.boundsPeriod.end.toString(),
        "2013-03-14");
    assertEquals(data.activity.get(2).detail.scheduledTiming.repeat.boundsPeriod.start.toString(),
        "2013-03-01");
    assertEquals(data.activity.get(2).detail.status,
        CodeSystems.CarePlanActivityStatus.NOT_STARTED);
    ...
    assertEquals(data.activity.get(3).detail.code.coding.get(0).system,
        "http://example.org/mySystem");
    ...
    assertEquals(data.activity.get(3).detail.prohibited, false);
    assertEquals(data.activity.get(3).detail.scheduledTiming.repeat.boundsPeriod.end.toString(),
        "2013-09-14");
    assertEquals(data.activity.get(3).detail.scheduledTiming.repeat.boundsPeriod.start.toString(),
        "2013-09-01");
    assertEquals(data.activity.get(3).detail.status,
        CodeSystems.CarePlanActivityStatus.NOT_STARTED);
    ...
    assertEquals(data.extension.get(0).url,
