...
public class FamilyMemberHistoryTest {
    ...
    public void testFamilyMemberHistory1() throws Exception {
        String sourceJson = FileHelper.loadString("familymemberhistory-example.json");
        ...
        assertEquals(data.condition.get(0).note.get(0).text,
        ...
        assertEquals(data.status, CodeSystems.FamilyHistoryStatus.COMPLETED);
    ...
    public void testFamilyMemberHistory2() throws Exception {
        String sourceJson = FileHelper.loadString("familymemberhistory-example-mother.json");
        FamilyMemberHistory data = parser.toFhir(FamilyMemberHistory.class, sourceJson);
