...
public class ProcedureTest {
    ...
    public void testProcedure1() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-f201-tpf.json");
    ...
    public void testProcedure2() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-ambulation.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
        ...
        assertEquals(data.status, CodeSystemEventStatus.SUSPENDED);
    ...
    public void testProcedure3() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-implant.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure4() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-colon-biopsy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure5() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-f004-tracheotomy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
        ...
        assertEquals(data.performer.get(0).role.coding.get(0).system, "urn:oid:2.16.840.1.113883.2.4.15.111");
    ...
    public void testProcedure6() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-education.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure7() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-colonoscopy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure8() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-physical-therapy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure9() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example-f003-abscess.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure10() throws Exception {
        String sourceJson = FileHelper.loadString("stu3/procedure-example.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
