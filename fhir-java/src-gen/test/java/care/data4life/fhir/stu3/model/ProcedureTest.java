...
public class ProcedureTest {
    ...
    public void testProcedure1() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-f201-tpf.json");
        ...
        assertEquals(data.status, CodeSystems.EventStatus.COMPLETED);
    ...
    public void testProcedure2() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-ambulation.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
        ...
        assertEquals(data.location.display,
        ...
        assertEquals(data.status, CodeSystems.EventStatus.SUSPENDED);
    ...
    public void testProcedure3() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-implant.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
        ...
        assertEquals(data.focalDevice.get(0).action.coding.get(0).system,
    ...
    public void testProcedure4() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-colon-biopsy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure5() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-f004-tracheotomy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
        ...
        assertEquals(data.performer.get(0).role.coding.get(0).system,
    ...
    public void testProcedure6() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-education.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure7() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-colonoscopy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure8() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-physical-therapy.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);

        assertEquals(data.basedOn.get(0).display,
    ...
    public void testProcedure9() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example-f003-abscess.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
    ...
    public void testProcedure10() throws Exception {
        String sourceJson = FileHelper.loadString("procedure-example.json");
        Procedure data = parser.toFhir(Procedure.class, sourceJson);
