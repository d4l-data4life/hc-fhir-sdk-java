...
public class CodeSystemTest {
    ...
    public void testCodeSystem1() throws Exception {
        String sourceJson = FileHelper.loadString("codesystem-example-supplement.json");
    ...
    public void testCodeSystem2() throws Exception {
        String sourceJson = FileHelper.loadString("codesystem-list-example-codes.json");
        CodeSystem data = parser.toFhir(CodeSystem.class, sourceJson);
    ...
    public void testCodeSystem3() throws Exception {
        String sourceJson = FileHelper.loadString("codesystem-examplescenario-actor-type.json");
        CodeSystem data = parser.toFhir(CodeSystem.class, sourceJson);
    ...
    public void testCodeSystem4() throws Exception {
        String sourceJson = FileHelper.loadString("codesystem-example-summary.json");
        CodeSystem data = parser.toFhir(CodeSystem.class, sourceJson);
    ...
    public void testCodeSystem5() throws Exception {
        String sourceJson = FileHelper.loadString("codesystem-example.json");
        CodeSystem data = parser.toFhir(CodeSystem.class, sourceJson);
