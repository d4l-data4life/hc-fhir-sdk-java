...
public class PractitionerTest {
    ...
    public void testPractitioner5() throws Exception {
        ...
        assertEquals(data.communication.get(0).coding.get(0).system, "urn:ietf:bcp:47");
        assertEquals(data.gender, CodeSystemAdministrativeGender.MALE);
    ...
    public void testPractitioner7() throws Exception {
        ...
        assertEquals(data.qualification.get(0).code.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/v2-0360/2.7");
