...
public class PractitionerTest {
    ...
    public void testPractitioner1() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f203-jvg.json");
    ...
    public void testPractitioner2() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f201-ab.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner3() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f202-lm.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner4() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-xcda-author.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner5() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f003-mv.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner6() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f002-pv.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner7() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner8() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f007-sh.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner9() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-f204-ce.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
    ...
    public void testPractitioner10() throws Exception {
        String sourceJson = FileHelper.loadString("r4/practitioner-example-xcda1.json");
        Practitioner data = parser.toFhir(Practitioner.class, sourceJson);
