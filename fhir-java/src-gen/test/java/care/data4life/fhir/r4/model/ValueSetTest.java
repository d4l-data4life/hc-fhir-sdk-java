...
public class ValueSetTest {
    ...
    public void testValueSet2() throws Exception {
        String sourceJson = FileHelper.loadString("valueset-example-hierarchical.json");
        ValueSet data = parser.toFhir(ValueSet.class, sourceJson);
    ...
    public void testValueSet5() throws Exception {
        String sourceJson = FileHelper.loadString("valueset-example-filter.json");
        ValueSet data = parser.toFhir(ValueSet.class, sourceJson);
    ...
    public void testValueSet7() throws Exception {
        String sourceJson = FileHelper.loadString("valueset-examplescenario-actor-type.json");
        ValueSet data = parser.toFhir(ValueSet.class, sourceJson);
