...
public class SpecimenTest {
    ...
    public void testSpecimen1() throws Exception {
        String sourceJson = FileHelper.loadString("specimen-example-isolate.json");
    ...
    public void testSpecimen2() throws Exception {
        String sourceJson = FileHelper.loadString("specimen-example-pooled-serum.json");
        Specimen data = parser.toFhir(Specimen.class, sourceJson);
    ...
    public void testSpecimen3() throws Exception {
        String sourceJson = FileHelper.loadString("specimen-example-urine.json");
        Specimen data = parser.toFhir(Specimen.class, sourceJson);
    ...
    public void testSpecimen4() throws Exception {
        String sourceJson = FileHelper.loadString("specimen-example-serum.json");
        Specimen data = parser.toFhir(Specimen.class, sourceJson);
    ...
    public void testSpecimen5() throws Exception {
        String sourceJson = FileHelper.loadString("specimen-example.json");
        Specimen data = parser.toFhir(Specimen.class, sourceJson);
