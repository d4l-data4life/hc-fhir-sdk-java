...
public class ConditionTest {
    ...
    public void testCondition1() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f003-abscess.json");
        ...
        assertEquals(data.clinicalStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-clinical");
        ...
        assertEquals(data.recordedDate.toString(), "2012-02-20");
        ...
        assertEquals(data.verificationStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-ver-status");
    ...
    public void testCondition2() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f203-sepsis.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.category.get(0).coding.get(1).system, "http://terminology.hl7.org/CodeSystem/condition-category");
        assertEquals(data.clinicalStatus.coding.get(0).code, "active");
        assertEquals(data.clinicalStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-clinical");
        assertEquals(data.code.coding.get(0).code, "10001005");
        assertEquals(data.code.coding.get(0).display, "Bacterial sepsis");
        assertEquals(data.code.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.encounter.display, "Roel's encounter on March elevanth");
        assertEquals(data.encounter.reference, "Encounter/f203");
        ...
        assertEquals(data.recordedDate.toString(), "2013-03-11");
    ...
    public void testCondition3() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-stroke.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.category.get(0).coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-category");
        assertEquals(data.clinicalStatus.coding.get(0).code, "active");
        assertEquals(data.clinicalStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-clinical");
    ...
    public void testCondition4() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-family-history.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
    ...
    public void testCondition5() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f002-lung.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.code.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.encounter.reference, "Encounter/f002");
        ...
        assertEquals(data.recordedDate.toString(), "2012-06-03");
        assertEquals(data.severity.coding.get(0).code, "24484000");
        assertEquals(data.severity.coding.get(0).display, "Severe");
        assertEquals(data.severity.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.stage.get(0).summary.coding.get(0).code, "258219007");
        assertEquals(data.stage.get(0).summary.coding.get(0).display, "stage II");
        assertEquals(data.stage.get(0).summary.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.stage.get(0).type.coding.get(0).code, "260998006");
        assertEquals(data.stage.get(0).type.coding.get(0).display, "Clinical staging (qualifier value)");
        assertEquals(data.stage.get(0).type.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.subject.display, "P. van de Heuvel");
        assertEquals(data.subject.reference, "Patient/f001");
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.verificationStatus.coding.get(0).code, "confirmed");
    ...
    public void testCondition6() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f205-infection.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.meta.tag.get(0).display, "test health data");
        assertEquals(data.meta.tag.get(0).system, "http://terminology.hl7.org/CodeSystem/v3-ActReason");
        assertEquals(data.recordedDate.toString(), "2013-04-04");
        assertEquals(data.subject.display, "Roel");
        assertEquals(data.subject.reference, "Patient/f201");
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
        assertEquals(data.verificationStatus.coding.get(0).code, "differential");
        assertEquals(data.verificationStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-ver-status");
    ...
    public void testCondition7() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f204-renal.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.category.get(0).coding.get(1).code, "problem-list-item");
        assertEquals(data.category.get(0).coding.get(1).system, "http://terminology.hl7.org/CodeSystem/condition-category");
        assertEquals(data.clinicalStatus.coding.get(0).code, "inactive");
        assertEquals(data.clinicalStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-clinical");
        ...
        assertEquals(data.severity.coding.get(0).display, "Severe");
        assertEquals(data.severity.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.stage.get(0).assessment.get(0).display, "Genetic analysis master panel");
        assertEquals(data.stage.get(0).summary.coding.get(0).code, "14803004");
        assertEquals(data.stage.get(0).summary.coding.get(0).display, "Temporary");
        assertEquals(data.stage.get(0).summary.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.subject.display, "Roel");
        assertEquals(data.subject.reference, "Patient/f201");
        assertEquals(data.text.status, CodeSystemNarrativeStatus.GENERATED);
    ...
    public void testCondition8() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example2.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
    ...
    public void testCondition9() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f202-malignancy.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.category.get(0).coding.get(0).code, "encounter-diagnosis");
        assertEquals(data.category.get(0).coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-category");
        assertEquals(data.clinicalStatus.coding.get(0).code, "resolved");
        assertEquals(data.clinicalStatus.coding.get(0).system, "http://terminology.hl7.org/CodeSystem/condition-clinical");
        ...
        assertEquals(data.meta.security.get(0).system, "http://terminology.hl7.org/CodeSystem/v3-ActCode");
        assertEquals(data.meta.tag.get(0).code, "HTEST");
        assertEquals(data.meta.tag.get(0).display, "test health data");
        assertEquals(data.meta.tag.get(0).system, "http://terminology.hl7.org/CodeSystem/v3-ActReason");
        ...
        assertEquals(data.recordedDate.toString(), "2012-12-01");
        assertEquals(data.severity.coding.get(0).code, "24484000");
        assertEquals(data.severity.coding.get(0).display, "Severe");
        assertEquals(data.severity.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.subject.display, "Roel");
    ...
    public void testCondition10() throws Exception {
        String sourceJson = FileHelper.loadString("r4/condition-example-f201-fever.json");
        Condition data = parser.toFhir(Condition.class, sourceJson);
        ...
        assertEquals(data.code.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.encounter.reference, "Encounter/f201");
        ...
        assertEquals(data.recordedDate.toString(), "2013-04-04");
        assertEquals(data.recorder.reference, "Practitioner/f201");
        assertEquals(data.severity.coding.get(0).code, "255604002");
        assertEquals(data.severity.coding.get(0).display, "Mild");
        assertEquals(data.severity.coding.get(0).system, "http://snomed.info/sct");
        assertEquals(data.subject.display, "Roel");
