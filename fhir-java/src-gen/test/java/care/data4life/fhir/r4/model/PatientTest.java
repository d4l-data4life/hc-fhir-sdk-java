...
public class PatientTest {
    ...
    public void testPatient4() throws Exception {
        String sourceJson = FileHelper.loadString("patient-example-infant-twin-1.json");
        Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    public void testPatient5() throws Exception {
        String sourceJson = FileHelper.loadString("patient-example-infant-mom.json");
        Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    public void testPatient6() throws Exception {
        String sourceJson = FileHelper.loadString("patient-example-newborn.json");
        Patient data = parser.toFhir(Patient.class, sourceJson);
    ...
    public void testPatient7() throws Exception {
        String sourceJson = FileHelper.loadString("patient-example-infant-fetal.json");
        Patient data = parser.toFhir(Patient.class, sourceJson);
