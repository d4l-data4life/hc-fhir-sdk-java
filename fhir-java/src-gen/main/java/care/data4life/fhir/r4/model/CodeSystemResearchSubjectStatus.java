...
public enum CodeSystemResearchSubjectStatus {
    ...
    /**
     * A person who did not meet one or more criteria required for participation in a study is considered to have failed
     * screening or is ineligible for the study.
     */
     ...
     * any intervention. Note that this state is study-dependent and might not exist in all studies.  A synonym for this
     * is "short-term follow-up".
     */
