...
public enum CodeSystemResourceType {
     ...
     * patient visit or stay.   The medication information may come from sources such as the
     * patient's memory, from a prescription bottle,  or from a list of medications the patient,
