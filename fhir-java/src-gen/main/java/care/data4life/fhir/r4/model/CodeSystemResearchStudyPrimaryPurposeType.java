...
public enum CodeSystemResearchStudyPrimaryPurposeType {
    ...
    /**
     * One or more interventions are evaluated for maximizing comfort, minimizing side effects, or
     * mitigating against a decline in the participant's health or function.
     */
    @Json(name = "supportive-care")
    SUPPORTIVE_CARE,

    /**
     * One or more interventions are assessed or examined for identifying a condition, or risk
     ...
     * physiology or biomechanics of an intervention).
     */
    @Json(name = "basic-science")
    BASIC_SCIENCE,

    /**
     * An intervention of a device product is being evaluated to determine the feasibility of the
     * product or to test a prototype device and not health outcomes. Such studies are conducted to
     * confirm the design and operating specifications of a device before beginning a full clinical
     * trial.
     */
