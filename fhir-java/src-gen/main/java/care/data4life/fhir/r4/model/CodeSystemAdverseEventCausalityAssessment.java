...
public enum CodeSystemAdverseEventCausalityAssessment {
     ...
     * recognized pharmacological phenomenon); or v) Re-challenge satisfactory, if necessary.
     */
    @Json(name = "Certain")
    CERTAIN,
    ...
    /**
     * i) Event or laboratory test abnormality, with a time to drug intake that makes a relationship improbable (but not
     * impossible); or ii) Disease or other drugs provide plausible explanations.
     */
    @Json(name = "Unlikely")
    UNLIKELY,
