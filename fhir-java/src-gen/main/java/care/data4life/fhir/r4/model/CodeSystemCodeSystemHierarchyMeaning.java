...
public enum CodeSystemCodeSystemHierarchyMeaning {
     ...
     * the definitions of the elements (possible reasons to use this: importing from a source where this is not defined,
     * or where various parts of the hierarchy have different meanings).
     */
