...
/**
 * General reasons for a list to be empty. Reasons are either related to a summary list (i.e. problem or medication
 * list) or to a workflow related list (i.e. consultation list).
 *
