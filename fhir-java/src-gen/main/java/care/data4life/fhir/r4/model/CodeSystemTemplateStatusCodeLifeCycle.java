...
public enum CodeSystemTemplateStatusCodeLifeCycle {
     ...
     * retired. Alternatively, the review may result in a change to the design that does not require a new version to be
     * created, or it may result in no change to the design at all.
     */
    @Json(name = "review")
    REVIEW,
    ...
    /**
     * A design is determined to be erroneous or not fit for the intended purpose and should no longer be used, even for
     * historical purposes. No new designs can be developed for this template. The associated template no longer needs
