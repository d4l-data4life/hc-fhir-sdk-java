...
public enum CodeSystemContractSignerTypeCodes {
    ...
    /**
     * An agent role in which the agent is an Entity acting in the employ of an organization. The focus is on functional
     * role on behalf of the organization, unlike the Employee role where the focus is on the 'Human Resources'
    ...
    /**
     * A person or an organization that provides or receives information regarding another entity. Examples; patient NOK
     * and emergency contacts; guarantor contact; employer contact.
     */
    @Json(name = "CONT")
    CONT,

    /**
     * A person who participates in the generation of and attest to veracity of content but is not an author or
     * co-author. For example, a surgeon who is required by institutional, regulatory, or legal rules to sign an
     * operative report, but who was not involved in the authorship of that report.
     */
    @Json(name = "COPART")
    COPART,

    /**
     * An entity, which is the insured, that receives benefits such as healthcare services, reimbursement for
     * out-of-pocket expenses, or compensation for losses through coverage under the terms of an insurance policy. The
     * underwriter of that policy is the scoping entity. The covered party receives coverage because of some contractual
     * or other relationship with the holder of that policy. Note that a particular policy may cover several individuals
     * one of whom may be, but need not be, the policy holder. Thus the notion of covered party is a role that is
     ...
     * circumstances, the dependent may be under the indirect authority of a responsible party acting as a surrogate for
     * the subscriber, for example, if the subscriber is differently-abled or deceased, a guardian ad lidem or estate
     * executor may be appointed to assume the subscriber's legal standing in the relationship with the dependent.
     */
    @Json(name = "DEPEND")
    DEPEND,
     ...
     * is a legally binding upon the person giving such authority as if he or she personally were to do the acts. Unlike
     * ordinary powers of attorney, durable powers can survive for long periods of time, and again, unlike standard
    ...
    /**
     * A person who converts spoken or written language into the language of key participants in an event such as when a
     * provider is obtaining a patient's consent to treatment or permission to disclose information.
     */
    @Json(name = "INTPRT")
    INTPRT,
     ...
     * grantor and grantee, and witnessing their signing of the contract or agreement such as a real estate transaction,
    ...
    /**
     * An entity that may, should receive, or has received information or an object, which might not have been primarily
     * addressed to it. For example, the staff of a provider, a clearinghouse, or other intermediary.
     */
    @Json(name = "RECIP")
    RECIP,
     ...
     * that is generated by a device for inclusion in the patient record; (2) the signature for an ECG derived by an ECG
     * system for inclusion in the patient record; (3) the data from a biomedical monitoring device or system that is
    ...
    /**
     * A person who has been granted the authority to represent or act on another's behalf for a limited set of specific
     * matters in a manner which is a legally binding upon the person giving such authority as if he or she personally
     * were to do the acts. Examples include (1) exercising specific legal rights belonging to the grantee such as
     * drafting a will; (2) performing specific legal duties on behalf of a grantee such as making a reversible mortgage
     * to pay for end of life expenses; and (3) making specific legal decisions concerning a grantee such as managing a
     * trust.
     */
    @Json(name = "SPOWATT")
    SPOWATT,
