...
public enum CodeSystemAllergyIntoleranceVerificationStatusCodes {
    ...
    /**
     * A propensity for a reaction to the identified substance has been disputed or disproven with a sufficient level of
     * clinical certainty to justify invalidating the assertion. This might or might not include testing or
     * rechallenge.
     */
    @Json(name = "refuted")
    REFUTED,
