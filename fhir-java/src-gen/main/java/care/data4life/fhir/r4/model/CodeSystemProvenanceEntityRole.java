...
public enum CodeSystemProvenanceEntityRole {
    ...
    /**
     * A transformation of an entity into another, an update of an entity resulting in a new one, or the construction of
     * a new entity based on a pre-existing entity.
     */
