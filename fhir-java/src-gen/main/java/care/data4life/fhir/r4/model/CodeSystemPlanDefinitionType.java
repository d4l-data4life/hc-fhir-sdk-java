...
public enum CodeSystemPlanDefinitionType {
     ...
     * as a checklist for the clinician when managing a patient with a specific condition. It is a structured collection
     * of orders relevant to that condition and presented to the clinician in a computerized provider order entry (CPOE)
     * system.
     */
    @Json(name = "order-set")
    ORDER_SET,
