...
public enum CodeSystemBindingStrength {
     ...
     * the value set can apply to the concept being communicated.  If the value set does not cover the concept (based on
     * human review), alternate codings (or, data type allowing, text) may be included instead.
     */
