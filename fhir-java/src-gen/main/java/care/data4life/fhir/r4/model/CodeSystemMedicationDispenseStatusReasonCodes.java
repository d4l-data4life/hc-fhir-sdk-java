...
public enum CodeSystemMedicationDispenseStatusReasonCodes {
     ...
     * available. Example: Lab results, diagnostic imaging, etc.
     */
    @Json(name = "frr03")
    FRR03,
     ...
     * ongoing monitoring by fulfiller and fulfiller will be ending practice, leaving town, unable to schedule necessary
     * time, etc.
     */
    @Json(name = "frr06")
    FRR06,
