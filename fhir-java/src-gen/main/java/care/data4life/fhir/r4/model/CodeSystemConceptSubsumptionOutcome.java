 ...
 * equivalent, subsumes, subsumed-by, and not-subsumed. If the server is unable to determine the relationship between
 * the codes/Codings, then it returns an error (i.e. an OperationOutcome).
 *
