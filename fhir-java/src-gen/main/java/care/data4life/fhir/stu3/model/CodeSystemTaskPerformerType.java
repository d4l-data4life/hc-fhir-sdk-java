...
public enum CodeSystemTaskPerformerType {
    ...
    /**
     * A workflow participant that schedules (dispatches and sets the time or date for performance
     * of) services.
     */
    @Json(name = "scheduler")
    SCHEDULER,
    ...
    /**
     * A workflow participant that acquires resources (specimens, images, etc) necessary to perform
     * the task.
     */
    @Json(name = "acquirer")
    ACQUIRER,
