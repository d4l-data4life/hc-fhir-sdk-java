...
public enum CodeSystemGoalStatus {
    ...
    /**
     * The goal is being sought but has not yet been reached.  (Also applies if goal was reached in
     * the past but there has been regression and goal is being sought again)
     */
