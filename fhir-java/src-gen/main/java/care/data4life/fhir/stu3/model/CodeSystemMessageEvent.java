...
public enum CodeSystemMessageEvent {
    ...
    /**
     * The definition of a code system is used to create a simple collection of codes suitable for
     * use for data entry or validation. An expanded code system will be returned, or an error
     * message.
     */
    ...
    /**
     * Someone wishes to record that the record of administration of a medication is in error and
     * should be ignored.
     */
    ...
    /**
     * Notification of a change to an administrative resource (either create or update). Note that
     * there is no delete, though some administrative resources have status or period elements for
     * this use.
     */
    ...
    /**
     * Notification that previous advice that two patient records concern the same patient is now
     ...
     * for data entry or validation. An expanded value set will be returned, or an error message.
     */
