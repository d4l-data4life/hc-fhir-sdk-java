 ...
 */
public enum CodeSystemSystemVersionProcessingMode {
     ...
     * giving a different list of codes that is both wrong and unsafe, and implementers should only
     * use this capability reluctantly. It primarily exists to deal with situations where
     * specifications have fallen into decay as time passes. If a  version is override, the version
     * used SHALL explicitly be represented in the expansion parameters
     */
    @Json(name = "override")
    OVERRIDE,
}
