...
public enum CodeSystemConceptMapEquivalence {
     ...
     * structural implications of meaning are identical or irrelevant (i.e. intentionally
     * identical).
     */
    @Json(name = "equal")
    EQUAL,
     ...
     * mapping is narrower SHALL be described in the comments in this case, and applications should
     * be careful when attempting to use these mappings operationally.
     */
    @Json(name = "narrower")
    NARROWER,
     ...
     * additional meaning, or the definitions are imprecise and it is uncertain whether they have
     * the same boundaries to their meaning. The sense in which the mapping is narrower SHALL be
     * described in the comments in this case, and applications should be careful when attempting to
     * use these mappings operationally.
     */
    @Json(name = "inexact")
    INEXACT,
