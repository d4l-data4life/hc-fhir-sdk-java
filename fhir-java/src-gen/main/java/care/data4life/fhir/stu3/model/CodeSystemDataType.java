...
public enum CodeSystemDataType {
     ...
     * infrastructure. Changes to the content may not always be associated with version changes to
     * the resource.
     */
    @Json(name = "Meta")
    META,
     ...
     * signature, or a signature process. Different signature approaches have different utilities.
     */
    @Json(name = "Signature")
    SIGNATURE,
    ...
    /**
     * A string that may contain markdown syntax for optional processing by a mark down presentation
     * engine
     */
    @Json(name = "markdown")
    MARKDOWN,
