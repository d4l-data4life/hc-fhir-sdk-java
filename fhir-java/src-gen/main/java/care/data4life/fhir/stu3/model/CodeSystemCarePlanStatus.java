...
/**
 * Indicates whether the plan is currently being acted upon, represents future intentions or is now
 * a historical record.
 *
...
public enum CodeSystemCarePlanStatus {
    ...
    /**
     * The plan has been terminated prior to reaching completion (though it may have been replaced
     * by a new plan).
     */
    @Json(name = "cancelled")
    CANCELLED,
