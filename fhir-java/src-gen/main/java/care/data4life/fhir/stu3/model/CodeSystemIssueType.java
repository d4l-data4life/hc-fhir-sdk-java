...
public enum CodeSystemIssueType {
     ...
     * pure RESTful environment, this would be an HTTP 404 error, but this code may be used where
    ...
    /**
     * Transient processing issues. The system receiving the error may be able to resubmit the same
     * content once an underlying issue is resolved.
     */
    @Json(name = "transient")
    TRANSIENT,
