 ...
 * scenario where this information is captured is during the history taking process during a patient
 * visit or stay.   The medication information may come from sources such as the patient's memory,
 * from a prescription bottle,  or from a list of medications the patient, clinician or other party
 * maintains.
 * <p>
...
public class MedicationStatement extends DomainResource {
    ...
    @Json(name = "status")
    public CodeSystemMedicationStatementStatusCodes status;
     ...
     *
     * @param status     CodeSystemMedicationStatementStatusCodes
     * @param medication as one of CodeableConcept, Reference*
     * @param subject    Reference
     */
    public MedicationStatement(CodeSystemMedicationStatementStatusCodes status, Object medication, Reference subject) {
        this.status = status;
